...
[Logisim evolution](https://github.com/logisim-evolution/logisim-evolution) ⭐ 7,569 | 🐛 108 | 🌐 Java | 📅 2026-09-14 is an educational software for designing and simulating digital logic circuits.

[GHDL](https://github.com/ghdl/ghdl) ⭐ 2,892 | 🐛 336 | 🌐 VHDL | 📅 2026-09-14 is an open-source analyzer, compiler, simulator and (experimental) synthesizer for VHDL, a Hardware Description Language (HDL). GHDL is not an interpreter it allows you to analyse and elaborate sources for generating machine code from your design.
...
[SpinalHDL](https://github.com/SpinalHDL/SpinalHDL) ⭐ 2,039 | 🐛 173 | 🌐 Scala | 📅 2026-09-13 is a Scala based HDL (Hardware Description Language) used to describe digital hardware.

[TerosHDL](https://github.com/TerosTechnology/vscode-terosHDL) ⭐ 738 | 🐛 233 | 🌐 VHDL | 📅 2026-08-07 is an open source IDE for HDL devlopers with functionalities commonly used by software developers. The IDE consist in a bunch of tools and on top of them is the VSCode plugin.
...
[Firmware Analysis and Comparison Tool](https://github.com/fkie-cad/FACT_core) ⭐ 1,464 | 🐛 148 | 🌐 Python | 📅 2026-09-14 is a tool intended to automate most of the firmware analysis process. It unpacks arbitrary firmware files and processes several analyses. Additionally, it can compare several images or single files.
...
[Azure SDK for C++](https://github.com/Azure/azure-sdk-for-cpp) ⭐ 205 | 🐛 174 | 🌐 C++ | 📅 2026-09-15
