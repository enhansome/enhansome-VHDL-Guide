...
[Logisim evolution](https://github.com/logisim-evolution/logisim-evolution) ⭐ 7,534 | 🐛 100 | 🌐 Java | 📅 2026-09-05 is an educational software for designing and simulating digital logic circuits.
...
[SpinalHDL](https://github.com/SpinalHDL/SpinalHDL) ⭐ 2,034 | 🐛 175 | 🌐 Scala | 📅 2026-09-05 is a Scala based HDL (Hardware Description Language) used to describe digital hardware.
...
[Vcpkg](https://github.com/microsoft/vcpkg) ⭐ 27,440 | 🐛 1,187 | 🌐 CMake | 📅 2026-09-04 is a C++ Library Manager for Windows, Linux, and MacOS.
