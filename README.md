...
[Logisim evolution](https://github.com/logisim-evolution/logisim-evolution) ⭐ 7,496 | 🐛 123 | 🌐 Java | 📅 2026-08-29 is an educational software for designing and simulating digital logic circuits.
...
[Unicorn](https://github.com/unicorn-engine/unicorn) ⭐ 9,275 | 🐛 214 | 🌐 C | 📅 2026-08-28 is a lightweight, multi-platform, multi-architecture CPU emulator framework(ARM, AArch64, M68K, Mips, Sparc, X86) based on [QEMU](https://www.qemu.org/).
...
[OpenSK](https://github.com/google/OpenSK) ⭐ 3,410 | 🐛 12 | 🌐 Rust | 📅 2026-08-06 is an open-source implementation for security keys written in Rust that supports both FIDO U2F and [FIDO2](https://fidoalliance.org/fido2/) standards.
