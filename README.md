...
[Logisim evolution](https://github.com/logisim-evolution/logisim-evolution) ⭐ 7,503 | 🐛 126 | 🌐 Java | 📅 2026-08-29 is an educational software for designing and simulating digital logic circuits.
...
[Apio](https://github.com/FPGAwars/apio) ⭐ 1,005 | 🐛 44 | 🌐 Python | 📅 2026-08-31 is a multiplatform toolbox, with static pre-built packages, project configuration tools and easy command interface to verify, synthesize, simulate and upload your verilog designs.
...
[Cloud Hypervisor](https://github.com/cloud-hypervisor/cloud-hypervisor) ⭐ 6,165 | 🐛 221 | 🌐 Rust | 📅 2026-08-29 is an open source Virtual Machine Monitor (VMM) that runs on top of [KVM](https://www.kernel.org/doc/Documentation/virtual/kvm/api.txt). The project focuses on exclusively running modern, cloud workloads, on top of a limited set of hardware architectures and platforms. Cloud workloads refers to those that are usually run by customers inside a cloud provider. Cloud Hypervisor is implemented in [Rust](https://www.rust-lang.org/) and is based on the [rust-vmm](https://github.com/rust-vmm) crates.
...
[OpenSK](https://github.com/google/OpenSK) ⭐ 3,414 | 🐛 12 | 🌐 Rust | 📅 2026-08-06 is an open-source implementation for security keys written in Rust that supports both FIDO U2F and [FIDO2](https://fidoalliance.org/fido2/) standards.
...
[QMK(Quantum Mechanical Keyboard) Firmware](https://github.com/qmk/qmk_firmware) ⭐ 20,667 | 🐛 550 | 🌐 C | 📅 2026-08-30 is an open-source keyboard firmware for Atmel AVR and [Arm](https://www.arm.com/) USB controllers, and more specifically, the [OLKB product line](https://olkb.com/), the [ErgoDox EZ keyboard](https://ergodox-ez.com/), and the [Clueboard product line](https://clueboard.co/).
